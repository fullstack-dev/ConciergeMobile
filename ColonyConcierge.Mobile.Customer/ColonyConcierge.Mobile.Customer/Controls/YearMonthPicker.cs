...
namespace ColonyConcierge.Mobile.Customer
{
	...
	public sealed class YearMonthPicker : Picker
	{
		...
		public static readonly BindableProperty SelectedItemProperty = BindableProperty.Create(nameof(SelectedItem), typeof(int), typeof(YearMonthPicker), default(int), BindingMode.TwoWay, null);
		public static readonly BindableProperty PickerTypeProperty = BindableProperty.Create(nameof(SelectionType), typeof(PickerType), typeof(YearMonthPicker), default(PickerType), BindingMode.TwoWay, null);
